...
void loop() {
  if(bluetooth.available()>0){
     ...
     */
    switch(angulo){
      case 1: girar(j2,20);break;
      case 2: girar(j2,40);break;
      case 3: girar(j2,60);break;
      case 4: girar(j2,80);break;
      case 5: girar(j2,100);break;
      case 6: girar(j2,120);break;
      case 7: girar(j2,140);break;
      case 8: girar(j2,160);break;
      case 9: girar(j2,180);break;
